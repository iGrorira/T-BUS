...
import 'package:runnn/user/bottom_nav_page/search_user.dart';
import 'package:runnn/user/bottom_nav_page/setting.dart';
import 'package:runnn/user/home_user.dart';
      ...
      bottomNavigationBar: Container(
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: GNav(
              textStyle: GoogleFonts.baiJamjuree(color: Colors.black),
